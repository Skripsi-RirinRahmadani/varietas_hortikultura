...
import {
  ...
  IconSparkles, IconCheck, IconBulb, IconHistory, IconArrowRight, IconLogin,
...
export default function PublicPredictPage() {
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center">
              <IconLeaf className="w-5 h-5 text-primary-foreground" />
            </div>
            <span className="font-headline font-black text-sm uppercase tracking-widest">SiVartas</span>
          </div>
          <div className="flex items-center gap-3">
            {!isLoggedIn ? (
              <>
                <Link href="/login" className="px-4 py-2 text-sm font-semibold hover:text-primary transition-colors">Masuk</Link>
                <Link href="/register" className="px-4 py-2 text-sm font-semibold bg-primary text-primary-foreground rounded-lg hover:opacity-90">Daftar</Link>
              </>
            ) : (
              <Link href="/dashboard" className="flex items-center gap-2 px-4 py-2 text-sm font-semibold bg-primary text-primary-foreground rounded-lg hover:opacity-90">
                <IconArrowRight className="w-4 h-4" /> Dashboard
              </Link>
            )}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
            <div>
              ...
              {!isLoggedIn && (
                <div className="mt-3 flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800/30 text-xs text-blue-700 dark:text-blue-400">
                  <IconLogin size={14} />
                  Hasil prediksi tidak akan disimpan. <Link href="/login" className="font-semibold hover:underline">Masuk akun</Link> untuk menyimpan riwayat.
                </div>
              )}
            </div>
