  ...
  return (
    <AppLayout title="Ikhtisar">
      ...
      <div className="mb-10">
        ...
        <p className="text-on-surface-variant max-w-2xl leading-relaxed">Performa sistem dan analisis hasil tanaman untuk Kabupaten Aceh Utara. Data disinkronisasi pada hari ini.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-4 bg-surface-container-lowest rounded-xl p-8 border border-outline-variant/15 flex flex-col justify-between">
          <div>
            <span className="text-xs font-bold uppercase tracking-widest text-primary mb-4 block">Total Arsip</span>
            <h2 className="text-6xl font-headline font-extrabold text-green-950 dark:text-green-50 mb-2">12,842</h2>
            <p className="text-on-surface-variant text-sm font-medium">Entri Data Terverifikasi</p>
          </div>
          <div className="mt-8 pt-6 border-t border-surface-container">
            <div className="flex items-center justify-between text-sm">
              <span className="text-on-surface-variant">Pertumbuhan dari kuartal terakhir</span>
        ...
        <div className="md:col-span-8 bg-surface-container-lowest rounded-xl overflow-hidden border border-outline-variant/15 flex flex-col md:flex-row">
          <div className="flex-1 p-8">
            ...
            <div className="space-y-6">
              <div>
                <div className="flex justify-between mb-2">
                  <span className="text-sm font-medium text-on-surface">Data Latih (80%)</span>
                  <span className="text-sm font-bold text-primary">10.273 rekaman</span>
                </div>
              ...
              <div>
                <div className="flex justify-between mb-2">
                  <span className="text-sm font-medium text-on-surface">Data Uji (20%)</span>
                  <span className="text-sm font-bold text-tertiary">2.569 rekaman</span>
                </div>
                <div className="h-3 w-full bg-secondary-container rounded-full overflow-hidden">
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-surface-container-low">
                <p className="text-xs font-semibold text-on-surface-variant uppercase mb-1">Akurasi Model</p>
                <p className="text-2xl font-bold text-green-900">94.2%</p>
              </div>
              <div className="p-4 rounded-lg bg-surface-container-low">
                <p className="text-xs font-semibold text-on-surface-variant uppercase mb-1">Delay Pemrosesan</p>
          ...
          <div className="w-full md:w-1/3 bg-primary-container relative min-h-[200px]">
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end text-white">
              ...
              <p className="text-sm font-medium leading-tight opacity-90">Classifier Random Forest menggunakan 500 decision tree untuk pemetaan wilayah yang optimal.</p>
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-12 bg-surface-container-low rounded-xl p-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
            <div>
              ...
              <h3 className="text-3xl font-bold">10 Komoditas Unggulan Teratas</h3>
            </div>
            <div className="flex gap-2">
              <span className="px-3 py-1 bg-secondary-container text-on-secondary-container rounded-full text-xs font-bold uppercase tracking-tight">Musim Aktif</span>
              <span className="px-3 py-1 bg-surface-container-highest text-on-surface-variant rounded-full text-xs font-bold uppercase tracking-tight">Dataset 2024</span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {[ 
              { name: 'Cabai', val: 95, label: '2.4k Ton' },
              { name: 'Tomat', val: 88, label: '2.1k Ton' },
              { name: 'Semangka', val: 75, label: '1.8k Ton' },
              { name: 'Mentimun', val: 68, label: '1.6k Ton' },
              { name: 'Padi', val: 62, label: '1.5k Ton' },
              { name: 'Jagung', val: 55, label: '1.2k Ton' },
              { name: 'Bawang Merah', val: 48, label: '1.1k Ton' },
              { name: 'Kubis', val: 42, label: '0.9k Ton' },
              { name: 'Terong', val: 35, label: '0.8k Ton' },
              { name: 'Bayam', val: 28, label: '0.6k Ton' },
            ].map((item, index) => (
        ...
        <div className="md:col-span-12 p-8 bg-tertiary text-white rounded-xl flex flex-col md:flex-row items-center gap-8 relative overflow-hidden">
          <div className="z-10 flex-1">
            <h4 className="text-2xl font-bold mb-4">Intelijen Tanah Strategis</h4>
            <p className="text-white/80 max-w-xl leading-relaxed mb-6">Model kami menyarankan peningkatan hasil sebesar 12% untuk area dataran rendah jika jadwal irigasi disesuaikan dengan prakiraan curah hujan terbaru.</p>
            <Link href="/dashboard/results" className="bg-white text-tertiary px-6 py-3 rounded-lg font-bold text-sm flex items-center gap-2 hover:bg-white/90 transition-colors">
      ...
      <footer className="mt-20 py-10 border-t border-surface-container flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <p className="text-xs text-on-surface-variant">© 2024 Arsitektur Sistem Pemerintah. Seluruh Hak Cipta Dilindungi.</p>
      </footer>
    </AppLayout>
  );
}
